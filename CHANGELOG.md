...
### Added
- **claude-switch-models-setup** (`daymade-claude-code` v1.30.0): add region-specific MiniMax-M3 and MiniMax-M2.7 profile templates with the current global and China compatible endpoints, verified context-window settings, and explicit thinking-mode behavior.
