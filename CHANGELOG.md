...
### Changed
- **frontend-visual-qa** v1.13.0: audit information necessity before fitting text into the layout. Inventory visible text, repeated encodings and label echoes across the full task surface; keep raw labels out of JSON reports and necessity explicitly unverified. Preserve task-dependent essential context and reject completion claims that merely downgrade an unmet user requirement. Validate capture and coverage boundaries with renderer-backed cases.
