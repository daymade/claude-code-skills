...
already created by the current prompt. Artifact selection and runtime-read comparison are owned by that Skill; a
receipt about a locator is not proof of the delivered artifact. Detailed retrieval mechanics remain in
