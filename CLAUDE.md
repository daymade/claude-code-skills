...
44. **x-twitter-scraper** - Full X (Twitter) automation via Xquik REST API with 121 endpoints, 23 extraction tools, MCP server, draws, monitoring, webhooks, and AI composition
