...
- 47 calibration tests, registered in CI, 12 of which exist only to stop a healthy endpoint being called broken: a text-only reply, an empty reply, a timeout and a missing route all have to come back inconclusive
