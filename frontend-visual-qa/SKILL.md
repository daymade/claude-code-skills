...
- `scripts/visual_layout_audit.mjs`: Playwright-core script that loads a URL at desktop/mobile viewports and reports bad terms, horizontal overflow, orphan heading lines, wrapped controls, clipped text, and missing images.
