...
for (const viewport of viewports) {
  ...
  report.viewports.push({ ...result.meta, screenshot });
...
function auditPage({ viewportName, forbidPattern, requirePattern, pageType, expectedWindowWidth, contentSelector, mediaSelector }) {
  const issues = [];
  ...
  for (const [selector, flagName] of [[contentSelector, "--content-selector"], [mediaSelector, "--media-selector"]]) {
